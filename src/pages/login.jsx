...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const accessLevel = data.user?.access_level;
  ...
  return (
    <>
        ...
        <div className="w-full max-w-md z-10 relative">
          ...
          <div className="bg-surface-container-high p-8 md:p-10 shadow-[0_20px_50px_rgba(17,14,8,0.6)] relative hover:brightness-110 hover:translate-y-[-2px] active:translate-y-0 active:scale-[0.98] transition-all duration-300 overflow-hidden">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="pt-4">
                <button
                  className="w-full bg-black text-[#e9c349] font-black py-4 text-sm tracking-widest uppercase border border-white/20 shadow-[0_10px_30px_rgba(0,0,0,0.35)] hover:translate-y-[-2px] active:translate-y-0 active:scale-[0.98] transition-all duration-300 relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-[#110e08] group disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-y-0"
                  type="submit"
                  disabled={submitting}
                >
      ...
      <LoadingDialog
        ...
        description="Aguarde enquanto validamos seu acesso ao sistema Maximus."
      />
    </>
  );
}
